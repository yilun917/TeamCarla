...
class YawController(object):
    ...
    def get_steering(self, linear_velocity, angular_velocity, current_velocity): #todo: add damping
        ...
        if abs(current_velocity) > 0.1:
            max_yaw_rate = abs(self.max_lat_accel / (current_velocity)) #Added scale
