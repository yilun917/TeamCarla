...
(cl:defmethod cl:initialize-instance :after ((m <WheelSpeedReport>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelSpeedReport)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_mkz_msgs-msg:<WheelSpeedReport> is deprecated: use dbw_mkz_msgs-msg:WheelSpeedReport instead.")))
...
(cl:defmethod front_left-val ((m <WheelSpeedReport>))
...
(cl:defmethod front_right-val ((m <WheelSpeedReport>))
...
(cl:defmethod rear_left-val ((m <WheelSpeedReport>))
...
(cl:defmethod rear_right-val ((m <WheelSpeedReport>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WheelSpeedReport>)))
  ...
  (cl:format cl:nil "Header header~%~%# Wheel speeds (rad/s)~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WheelSpeedReport)))
  "Returns full string definition for message of type 'WheelSpeedReport"
  (cl:format cl:nil "Header header~%~%# Wheel speeds (rad/s)~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
