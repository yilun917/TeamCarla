...
class BrakeReport(genpy.Message):
  _md5sum = "a92bad28c400885f36170c1cab44618e"
...
"""
  __slots__ = ['header','pedal_input','pedal_cmd','pedal_output','torque_input','torque_cmd','torque_output','boo_input','boo_cmd','boo_output','enabled','override','driver','timeout','watchdog_counter','watchdog_braking','fault_wdc','fault_ch1','fault_ch2','fault_power']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pedal_input,pedal_cmd,pedal_output,torque_input,torque_cmd,torque_output,boo_input,boo_cmd,boo_output,enabled,override,driver,timeout,watchdog_counter,watchdog_braking,fault_wdc,fault_ch1,fault_ch2,fault_power
